...
ADAPTERS: dict[str, AdapterRule] = {
    ...
    "mmpose_dwpose": AdapterRule(
        name="mmpose_dwpose",
        origin="github_wholebody_pose_estimation_tool",
        allowed_routes=("pose_conditioned_provider_candidate", "external_animation_provider_candidate"),
        allowed_use="extract body, hand, face, and foot pose-only guides from self-owned or de-identified motion references",
    ...
    "animate_anyone": AdapterRule(
        name="animate_anyone",
        origin="github_pose_conditioned_reference_animation_tool",
        allowed_routes=("pose_conditioned_provider_candidate", "external_animation_provider_candidate"),
        allowed_use="animate a reference character from a pose guide sequence, then extract frames and re-import through SoFunny gates",
        hosted_upload_possible=True,
        requires_deidentification=True,
        requires_reimport=True,
    ),
    "magic_animate": AdapterRule(
        name="magic_animate",
        origin="github_densepose_conditioned_reference_animation_tool",
        allowed_routes=("pose_conditioned_provider_candidate", "external_animation_provider_candidate"),
        allowed_use="animate a reference character from DensePose-style motion conditioning, then extract frames and re-import through SoFunny gates",
        hosted_upload_possible=True,
        requires_deidentification=True,
        requires_reimport=True,
    ),
